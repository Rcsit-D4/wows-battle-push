...
TOOL_DESCRIPTION = (
    ...
    "回复规范：查询完成并回复结果后，本轮任务即结束——只汇报查询到的数据，"
    "不要追加与查询无关的建议、闲聊或额外发挥；除非用户再次提问，不要重复调用本工具或继续发表其他言论。"
)
